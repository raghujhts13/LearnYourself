...
import { Eraser, History, Minimize2, PencilLine, RotateCcw, Hand, PenTool, Type, Square, Circle, Trash2 } from 'lucide-react';
import { WhiteboardCanvas } from './whiteboard-canvas';
import type { WhiteboardCanvasHandle, DrawingTool } from './whiteboard-canvas';
...
export function Whiteboard({ isOpen, onClose }: WhiteboardProps) {
  ...
  const [activeColor, setActiveColor] = useState<string>('#9333ea');
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex items-center gap-1 bg-gray-100/50 dark:bg-gray-800/50 p-1 rounded-lg">
                  <button
                    ...
                    className={`p-1.5 rounded-md transition-colors ${activeTool === 'pan' ? 'bg-white dark:bg-gray-700 shadow-sm text-purple-600' : 'text-gray-500 hover:bg-gray-200/50 dark:hover:bg-gray-700/50'}`}
                    title="Pan"
                  >
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded-md transition-colors ${activeTool === 'pen' ? 'bg-white dark:bg-gray-700 shadow-sm text-purple-600' : 'text-gray-500 hover:bg-gray-200/50 dark:hover:bg-gray-700/50'}`}
                    title="Draw"
                  >
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded-md transition-colors ${activeTool === 'rect' ? 'bg-white dark:bg-gray-700 shadow-sm text-purple-600' : 'text-gray-500 hover:bg-gray-200/50 dark:hover:bg-gray-700/50'}`}
                    title="Rectangle"
                  >
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded-md transition-colors ${activeTool === 'circle' ? 'bg-white dark:bg-gray-700 shadow-sm text-purple-600' : 'text-gray-500 hover:bg-gray-200/50 dark:hover:bg-gray-700/50'}`}
                    title="Circle"
                  >
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded-md transition-colors ${activeTool === 'text' ? 'bg-white dark:bg-gray-700 shadow-sm text-purple-600' : 'text-gray-500 hover:bg-gray-200/50 dark:hover:bg-gray-700/50'}`}
                    title="Text"
                  >
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded-md transition-colors ${activeTool === 'erase' ? 'bg-white dark:bg-gray-700 shadow-sm text-red-500' : 'text-gray-500 hover:bg-gray-200/50 dark:hover:bg-gray-700/50'}`}
                    title="Erase element"
                  >
