# Contributing to LearnYourself

Thanks for stopping by! To ensure a consistent and efficient workflow for everyone, please follow these guidelines when contributing to LearnYourself.
...
| **New feature or architecture change** | Start a [GitHub Discussion](https://github.com/raghujhts13/LearnYourself/discussions) **before** opening a PR |
| **Design / UI change** | Discuss in a [GitHub Discussion](https://github.com/raghujhts13/LearnYourself/discussions) — include mockups or screenshots |
| **Documentation** | Open a PR directly |
| **Question** | Ask me directly or in [GitHub Discussion](https://github.com/raghujhts13/LearnYourself/discussions) |
...
git clone https://github.com/raghujhts13/LearnYourself.git
cd LearnYourself
...
Use the [Bug Report](https://github.com/raghujhts13/LearnYourself/issues/new?template=bug_report.yml) issue template. Include:
...
Use the [Feature Request](https://github.com/raghujhts13/LearnYourself/issues/new?template=feature_request.yml) issue template. For larger features, please open a [Discussion](https://github.com/raghujhts13/LearnYourself/discussions) first.

## Security Vulnerabilities

Please report security vulnerabilities through [GitHub Security Advisories](https://github.com/raghujhts13/LearnYourself/security/advisories/new). **Do not** open a public issue for security vulnerabilities.

## License

By contributing to LearnYourself, you agree that your contributions will be licensed under the [AGPL-3.0 License](LICENSE).