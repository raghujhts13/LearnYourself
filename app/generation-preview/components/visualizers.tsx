...
function ContentVisualizer() {
  ...
  // 1: Quiz (Purple)
  // 2: PBL (Amber)
  // [INTERACTIVE DISABLED] Interactive (Emerald) type removed
  const totalTypes = 3;
  ...
  const getTheme = (idx: number) => {
    switch (idx) {
      ...
      // [INTERACTIVE DISABLED] case 3 (Interactive/WEB) removed
      default:
      ...
      <div className="w-40 h-28 relative">
        <AnimatePresence mode="popLayout">
          ...
          >
            ...
            {/* [INTERACTIVE DISABLED] Interactive type visualization removed */}
