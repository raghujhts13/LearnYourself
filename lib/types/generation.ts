...
export interface SceneOutline {
  id: string;
  type: 'slide' | 'quiz' | 'interactive' | 'pbl'; // [INTERACTIVE DISABLED] 'interactive' kept for type compat but never generated
  title: string;
  ...
  // [INTERACTIVE DISABLED] Interactive-specific config (kept for type compat)
  interactiveConfig?: {
    conceptName: string;
...
// ==================== Interactive Generation Types (DISABLED) ====================

/**
 * Scientific model output from scientific modeling stage (DISABLED)
 */
...
/**
 * AI-generated interactive content (DISABLED)
 */
