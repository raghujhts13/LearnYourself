...
export type SceneType = 'slide' | 'quiz' | 'interactive' | 'pbl'; // [INTERACTIVE DISABLED] 'interactive' kept for type compat
...
export interface Scene {
  ...
  // User-authored speaker notes (optional; if absent the export falls back to speech actions)
  speakerNotes?: string;
...
/**
 * Interactive content - Interactive web page (iframe) (DISABLED)
 */
