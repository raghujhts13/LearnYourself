...
// Currently handles: openai (native), anthropic (native).
// OpenAI-compatible providers (Ollama, etc.) are NOT
 ...
 *
 * For native providers (OpenAI/Anthropic), this sets providerOptions.
